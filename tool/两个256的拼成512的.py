...
# 保存拼接后图像的输出目录
output_dir = "C:\\Users\DELL\Desktop\sj\\8\\"

# 第一个文件夹中的图片所处路径（需要拼接成左半部分）
input_dir_1 = "C:\\Users\DELL\Desktop\sj\\6\\"

# 第二个文件夹中的图片所处路径（需要拼接成右半部分）
input_dir_2 = "C:\\Users\DELL\Desktop\sj\\7\\"
...
def combine_images():
    ...
    for i, (file_path_1, file_path_2) in enumerate(matched_file_paths):
        ...
        # 创建新的空白图像，大小为 512x256
        combined_image = Image.new('RGB', (512, 256), (0, 0, 0))

        # 将两张图片分别复制到新图像中的左、右两部分
        combined_image.paste(img1, (0, 0))
        combined_image.paste(img2, (256, 0))
